    ...
    <div className="flex items-center justify-between w-full gap-10 lg:px-[40px] pt-[6px] pb-[6px] px-[50px]">
      ...
      {show && (
        <div className="lg:hidden flex flex-col w-[300px] top-0 fixed h-full left-0 gap-2  z-[1] bg-white">
          ...
          <Link to='/'>
  <div className="border border-gray-200 flex gap-2 text-white bg-gradient-to-r from-red-500 via-red-600 to-red-500  items-center w-[250px] justify-center py-2 transition-all duration-300">
    Home
  </div>
</Link>
